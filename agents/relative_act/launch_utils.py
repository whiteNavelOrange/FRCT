...
from agents.relative_act.perceiver_lang_io import  PerceiverVoxelLang2RobotsEncoder
from agents.relative_act.qattention_peract_bc_agent import QAttentionPerActBCAgent2Robots
from agents.relative_act.qattention_stack_agent import  QAttentionStackAgent2Robots
...
def create_agent(cfg: DictConfig):
    ...
    for depth, vox_size in enumerate(cfg.method.voxel_sizes):
        ...
        qattention_agent = QAttentionPerActBCAgent2Robots(
            ...
            relative_loss_weight=cfg.method.relative_loss_weight,
